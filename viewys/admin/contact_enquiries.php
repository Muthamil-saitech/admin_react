	...
	<div class="row">
		...
		<div class="col-lg-12 grid-margin stretch-card">
			<div class="card">
				<div class="card-body">
					<div class="row">
						<h4 class="text-left card-title col-sm-6 col-form-label">Contact Enquiries</h4>
						<h4 class="text-right col-sm-6">
							Total Contact Enquiries : <strong class="text-primary" id="total_contact_enquiries"></strong><br>
						</h4>
					</div>
